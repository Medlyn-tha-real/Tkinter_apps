...
while 1:
   ...
   # if counter == 3:
    ...
    #     paddle.y = 0
    #     paddle1.y = 0
    #     canvas.create_text(250, 200, text="Congrats Player 1!! You won!", font = 32, fill="red")
    ...
    #     paddle.y = 0
    #     paddle1.y = 0
    #     canvas.create_text(250, 200, text="Congrats Player 2!! You won!", font = 32, fill="red")
    #     canvas.create_text(250, 215, text="Score:" + str(counter) + "-" + str(counter1), font=32, fill="red")
